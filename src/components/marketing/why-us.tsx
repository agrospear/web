...
/** Home: "Powered by Agrospear" — factory photo with four capability bullets. */
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <Reveal>
          <div className="relative overflow-hidden rounded-[28px] border border-border-2 shadow-[var(--shadow-lg)]">
            <ResponsiveImage src={assetUrl(c.image)} alt={c.imageCaption} width={800} height={600} sizes="(max-width: 1024px) 100vw, 50vw" className="aspect-[4/3] w-full object-cover" />
