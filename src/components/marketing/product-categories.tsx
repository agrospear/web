...
const CATEGORIES_EN: CategoryCard[] = [
  {
    ...
    image: assetUrl(ASSET_KEYS.categories.herbicides),
  ...
  },
  {
    ...
    image: assetUrl(ASSET_KEYS.categories.insecticides),
  ...
  },
  {
    ...
    image: assetUrl(ASSET_KEYS.categories.fungicides),
  ...
  },
  {
    ...
    image: assetUrl(ASSET_KEYS.categories.pgr),
    href: '/products/pgr',
    gradFrom: '#ecfdf5',
    gradTo: '#d1fae5',
  },
