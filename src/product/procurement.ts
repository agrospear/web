...
export const procurementProfiles: Localized<Record<string, ProcurementProfile>> = {
  en: {
    'all-around': {
      ...
      construction: 'SC or EC formulation type',
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'SC or EC formulation type' },
        { label: 'Rider weight', value: '60–110 kg optimal' },
        { label: 'Max payload', value: '140 kg' },
        { label: 'Active concentration / purity', value: 'Spec per formulation / ≥95% technical grade' },
    ...
    race: {
      ...
      construction: 'WDG high-potency formulation',
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'WDG high-potency formulation' },
    ...
    touring: {
      ...
      construction: 'WP stable suspension formulation',
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'WP stable suspension formulation' },
    ...
    yoga: {
      bestFor: 'Vegetable growers, greenhouse operations and integrated pest management programs',
      ...
      leadTime: `Samples in ${FACTS.sampleTime} · production in ${FACTS.leadTime} after confirmed PO and deposit`,
      specRows: [
        { label: 'Use scenario', value: 'Vegetable growers, greenhouse operations, integrated pest management programs' },
    ...
    whitewater: {
      ...
      construction: 'Project-specific formulation and packaging with custom labeling options',
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'Project-specific formulation and packaging, custom labeling options' },
        { label: 'Packaging', value: '1–20 L HDPE / 200 L drum options' },
        { label: 'Standard package', value: 'Labeled containers, COA, SDS, and regulatory documentation' },
      ],
      keyQuestions: [
    ...
    kids: {
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'SL fast-acting formulation with regulatory-compliant labeling' },
    ...
    multi: {
      ...
      construction: 'CS capsule suspension with dual active ingredients',
      ...
      specRows: [
        ...
        { label: 'Construction', value: 'CS capsule suspension with dual active ingredients' },
  ...
  es: {
    'all-around': {
      ...
      construction: 'Formulación tipo SC o EC',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Formulación tipo SC o EC' },
        { label: 'Peso del rider', value: '60–110 kg óptimo' },
        { label: 'Carga máxima', value: '140 kg' },
        { label: 'Concentración activa / pureza', value: 'Espec por formulación / ≥95% grado técnico' },
    ...
    race: {
      ...
      construction: 'Formulación WDG de alta potencia',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Formulación WDG de alta potencia' },
    ...
    touring: {
      ...
      construction: 'Formulación WP de suspensión estable',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Formulación WP de suspensión estable' },
    ...
    yoga: {
      bestFor: 'Cultivadores de hortalizas, invernaderos y programas de manejo integrado de plagas',
      ...
      leadTime: `Muestras en ${FACTS.sampleTime} · producción en ${FACTS.leadTime} tras confirmar PO y depósito`,
      specRows: [
        { label: 'Escenario de uso', value: 'Cultivadores de hortalizas, invernaderos, programas de manejo integrado de plagas' },
    ...
    whitewater: {
      ...
      construction: 'Formulación y embalaje específicos del proyecto con opciones de etiquetado personalizado',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Formulación y embalaje específicos del proyecto, opciones de etiquetado personalizado' },
        { label: 'Embalaje', value: 'HDPE 1–20 L / tambor 200 L' },
        { label: 'Paquete estándar', value: 'Contenedores etiquetados, COA, SDS y documentación reglamentaria' },
      ],
      keyQuestions: [
    ...
    kids: {
      ...
      construction: 'Formulación SL de acción rápida con etiquetado conforme a normativas',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Formulación SL de acción rápida con etiquetado conforme a normativas' },
    ...
    multi: {
      ...
      construction: 'Suspensión en cápsula CS con dos ingredientes activos',
      ...
      specRows: [
        ...
        { label: 'Construcción', value: 'Suspensión en cápsula CS con dos ingredientes activos' },
