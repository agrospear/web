  ...
  en: [
    {
      ...
      metaTitle: 'How Custom SUP Boards Are Developed | Agrospear',
      metaDescription:
    ...
    },
    {
      ...
      metaTitle: 'Inflatable SUP Construction: Materials & Layers | Agrospear',
      metaDescription:
  ...
  es: [
    {
      ...
      metaTitle: 'Cómo se desarrollan tablas de SUP personalizadas | Agrospear',
      metaDescription:
...
export const knowledgeMeta: Localized<KnowledgeMeta> = {
  en: {
    metaTitle: 'Knowledge Center: SUP Product Development Guides | Agrospear',
    metaDescription:
  ...
  es: {
    metaTitle: 'Centro de conocimiento — guías de productos | Agrospear',
    metaDescription:
