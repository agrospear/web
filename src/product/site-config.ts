...
export const SITE_FACTS = {
  ...
  batchYieldNote: FACTS.batchYieldNote,
  ...
  reactorAccuracy: FACTS.reactorAccuracy,
  reactorLines: FACTS.reactorLines,
  reactorPressure: FACTS.reactorPressure,
  packagingGrade: FACTS.packagingGrade,
  qcChecklistPoints: FACTS.qcChecklistPoints,
  qualityTest: FACTS.qualityTest,
  qualityReject: FACTS.qualityReject,
