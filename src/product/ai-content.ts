...
export const HUB_PAGE_ENTRIES: Record<string, { url: string; title: string; excerpt: string }[]> = {
  en: [
    { url: '/', title: 'Agrospear — Inflatable SUP OEM & ODM Manufacturing', excerpt: 'Qingdao SUP OEM/ODM factory: product development, custom manufacturing, private label and quality control for paddle board brands.' },
    ...
    { url: '/gallery', title: 'Gallery', excerpt: 'Agrospear factory and product gallery: workshops, quality labs, fabric testing and SUP boards in production.' },
  ],
  es: [
    { url: '/es', title: 'Agrospear — Fabricación OEM y ODM de SUP hinchables', excerpt: 'Fábrica OEM/ODM de SUP hinchables en Qingdao: desarrollo de producto, producción a medida, marca privada y control de calidad.' },
    ...
    { url: '/es/gallery', title: 'Galería', excerpt: 'Fábrica y galería de productos Agrospear: talleres, laboratorios de calidad, ensayos de tejido y tablas de SUP en producción.' },
  ],
}
...
export const JSONLD_KEYWORDS: Record<string, { keywords: string[]; articleTitle?: string }> = {
  ...
  '/proof-center': {
    keywords: ['SUP Manufacturing', 'Factory Evidence and Certificate Scope', 'Entity Relationship (Agrospear, content, Vatrad)', 'Batch Traceability and Record Keeping'],
