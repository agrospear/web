...
export const hero: Localized<HeroContent> = {
  en: {
    kicker: 'Custom Herbicides · Insecticides · Fungicides · PGR · Private Label · Registration Support',
    titlePre: 'Your Trusted Agrochemical OEM Partner for',
    titleAccent: 'Custom Crop Protection Formulations',
    titlePost: 'From R&D to export-ready products — private label, OEM & ODM solutions for 60+ countries',
    sub: `Agrospear is a designated agrochemical manufacturer in Qingdao, China, offering end-to-end OEM/ODM services: custom formulation development, private label packaging, and registration support. Eight formulation types (SC, EC, WP, WDG, SL, ME, CS, FS), 50,000+ tons annual capacity, and ${FACTS.exportCountries} export markets served.`,
    ctaPrimary: 'Start Your Agrochemical Project',
    ctaSecondary: 'View Factory & Quality Evidence',
    ctaTertiary: '',
    ctaQuartiary: '',
    ctaMicro: `Reply within ${FACTS.ndaWindow} · NDA available before file exchange · MOQ confirmed after specification review`,
    stats: [
      { value: FACTS.warehouseM2, label: 'Integrated manufacturing plant' },
      { value: FACTS.annualCapacity, label: 'Annual production capacity' },
      { value: FACTS.exportCountries, label: 'Export markets worldwide' },
      { value: FACTS.ndaWindow, label: 'NDA response window' },
    ],
    mockupLabel: 'Custom Formulation',
    mockupBrand: 'Your Product · Your Label',
    mockupHint: 'Herbicides · Insecticides · Fungicides · PGR · Seed Treatment',
  ...
  es: {
    kicker: 'Herbicidas · Insecticidas · Fungicidas · PGR a medida · Marca propia · Soporte de registro',
    titlePre: 'Tu socio OEM de agroquímicos para',
    titleAccent: 'formulaciones personalizadas de protección de cultivos',
    titlePost: 'Del R&D al producto listo para exportar — marca propia, OEM y soluciones ODM para 60+ países',
...
/* ─────────────────────────── home: why global buyers choose agrospear ─────────────────────────── */
...
export interface WhyGlobalBuyersContent {
  kicker: string
  title: string
  sub: string
  reasons: BuyerReason[]
...
export const whyGlobalBuyers: Localized<WhyGlobalBuyersContent> = {
  en: {
...
export const formulationCategories: Localized<FormulationCategoriesContent> = {
  en: {
    ...
    viewLabel: 'View',
    items: [
      { id: 'herbicide', label: 'Herbicides', desc: 'Selective and non-selective weed control formulations for all crop types.', image: 'https://assets.agrospear.com/images/agrochemical/products/herbicides-category.webp', href: '/products/herbicides/glyphosate-41-sl' },
      { id: 'insecticide', label: 'Insecticides', desc: 'Systemic, contact and translaminar insecticides for chewing and sucking pests.', image: 'https://assets.agrospear.com/images/agrochemical/products/insecticides-category.webp', href: '/products/insecticides/imidacloprid-350-sc' },
      { id: 'fungicide', label: 'Fungicides', desc: 'Preventive and curative fungicides for foliar and soil-borne diseases.', image: 'https://assets.agrospear.com/images/agrochemical/products/fungicides-category.webp', href: '/products/fungicides/azoxystrobin-250-sc' },
      { id: 'pgr', label: 'Plant Growth Regulators', desc: 'Growth promoters and inhibitors for yield and quality enhancement.', image: 'https://assets.agrospear.com/images/agrochemical/products/pgr-category.webp', href: '/products/pgr' },
      { id: 'seed-treatment', label: 'Seed Treatment', desc: 'FS and WS formulations for seed dressing and coating applications.', image: 'https://assets.agrospear.com/images/agrochemical/products/fungicides-category.webp', href: '/products/seed-treatment' },
    ],
  },
  es: {
    ...
    viewLabel: 'Ver',
    items: [
      { id: 'herbicide', label: 'Herbicidas', desc: 'Formulaciones selectivas y no selectivas de control de malezas para todos los cultivos.', image: 'https://assets.agrospear.com/images/agrochemical/products/herbicides-category.webp', href: '/products/herbicides/glyphosate-41-sl' },
      { id: 'insecticide', label: 'Insecticidas', desc: 'Insecticidas sistémicos, de contacto y translaminares para plagas masticadoras y chupadoras.', image: 'https://assets.agrospear.com/images/agrochemical/products/insecticides-category.webp', href: '/products/insecticides/imidacloprid-350-sc' },
      { id: 'fungicide', label: 'Fungicidas', desc: 'Fungicidas preventivos y curativos para enfermedades foliares y del suelo.', image: 'https://assets.agrospear.com/images/agrochemical/products/fungicides-category.webp', href: '/products/fungicides/azoxystrobin-250-sc' },
      { id: 'pgr', label: 'Reguladores de crecimiento', desc: 'Promotores e inhibidores de crecimiento para mejora de rendimiento y calidad.', image: 'https://assets.agrospear.com/images/agrochemical/products/pgr-category.webp', href: '/products/pgr' },
      { id: 'seed-treatment', label: 'Tratamiento de semillas', desc: 'Formulaciones FS y WS para desinfección y recubrimiento de semillas.', image: 'https://assets.agrospear.com/images/agrochemical/products/fungicides-category.webp', href: '/products/seed-treatment' },
    ],
  },
}
