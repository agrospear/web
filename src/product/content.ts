...
export const why: Localized<WhyContent> = {
  en: {
    ...
    sub: 'Agrospear is the SUP product development and manufacturing division of Agrospear, the manufacturing division of Qingdao Vatrad Group Co., Ltd. Our 12,500 m² plant in Laixi, Qingdao has produced inflatable products since 2012, with 25+ engineers across R&D, mold design, materials lab and production engineering averaging 7+ years in inflatable manufacturing, running two production shifts daily.',
    image: 'https://assets.agrospear.com/images/sups/factory/agrospear-production-department.webp',
    ...
    items: [
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-03.avif',
        hue: 195,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/whitewater/whitewater-01.avif',
        hue: 210,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/surf/surf-01.avif',
        hue: 28,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/kids-teens/kids-teens-05.avif',
        hue: 260,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/touring/touring-02.avif',
        hue: 210,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/yoga/yoga-01.avif',
        hue: 150,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-10.avif',
        hue: 28,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/race/race-01.avif',
        hue: 195,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-12.avif',
        hue: 170,
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-17.avif',
        hue: 330,
      },
      {
        slug: 'sup-rheo-race',
        ...
        image: 'https://assets.agrospear.com/site/products/2026/race/race-11.avif',
        hue: 195,
      },
      {
        slug: 'sup-fishing',
        ...
        image: 'https://assets.agrospear.com/site/products/2026/fishing/fishing-01.avif',
        hue: 210,
      },
      {
        slug: 'sup-mini',
        ...
        image: 'https://assets.agrospear.com/site/products/2026/mini/mini-01.avif',
        hue: 28,
      },
      {
        slug: 'sup-giant',
        ...
        image: 'https://assets.agrospear.com/site/products/2026/giant/giant-03.avif',
        hue: 195,
      },
      {
        slug: 'sup-lure-skiff',
        ...
        image: 'https://assets.agrospear.com/site/products/2026/utility-lure/utility-lure-01.avif',
        hue: 170,
      },
    ],
  },
...
export const boardCategories: Localized<BoardCategoriesContent> = {
  en: {
    ...
    viewLabel: 'View',
    items: [
      { id: 'all-around', label: 'All-Around', desc: 'Versatile SUP boards for paddlers of all skill levels.', image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-03.avif', href: '/products/sup-explorer-11' },
      { id: 'touring', label: 'Touring SUP', desc: 'Long-distance boards for exploration and adventure.', image: 'https://assets.agrospear.com/site/products/2026/touring/touring-02.avif', href: '/products/sup-dolphin-wave' },
      { id: 'race', label: 'Race', desc: 'Performance boards for racing and athletic paddling.', image: 'https://assets.agrospear.com/site/products/2026/race/race-01.avif', href: '/products/sup-leviathan-wake' },
      { id: 'whitewater', label: 'Whitewater', desc: 'Rugged boards engineered for river rapids and lifestyle.', image: 'https://assets.agrospear.com/site/products/2026/whitewater/whitewater-01.avif', href: '/products/sup-ocean-pulse' },
      { id: 'yoga', label: 'Yoga', desc: 'Spacious decks designed for yoga and fitness.', image: 'https://assets.agrospear.com/site/products/2026/yoga/yoga-01.avif', href: '/products/sup-flowing-lotus' },
      { id: 'surf', label: 'Surf', desc: 'Agile boards for catching waves and surf riding.', image: 'https://assets.agrospear.com/site/products/2026/surf/surf-01.avif', href: '/products/sup-cheetah-surge' },
      { id: 'fishing', label: 'Fishing', desc: 'Stable platforms with rod holders and utility hulls for angling.', image: 'https://assets.agrospear.com/site/products/2026/fishing/fishing-01.avif', href: '/products/sup-fishing' },
      { id: 'kids', label: 'Kids SUPs', desc: 'Smaller, lighter boards designed for children.', image: 'https://assets.agrospear.com/site/products/2026/kids-teens/kids-teens-05.avif', href: '/products/sup-mini' },
      { id: 'multi', label: 'Multi-Person', desc: 'Large-format team boards for 6–8 riders.', image: 'https://assets.agrospear.com/site/products/2026/giant/giant-03.avif', href: '/products/sup-giant' },
    ],
  },
  es: {
    ...
    viewLabel: 'Ver',
    items: [
      { id: 'all-around', label: 'Polivalente', desc: 'Tablas SUP versátiles para remeros de todos los niveles.', image: 'https://assets.agrospear.com/site/products/2026/all-around/all-around-03.avif', href: '/products/sup-explorer-11' },
      { id: 'touring', label: 'SUP de Travesía', desc: 'Tablas de larga distancia para exploración y aventura.', image: 'https://assets.agrospear.com/site/products/2026/touring/touring-02.avif', href: '/products/sup-dolphin-wave' },
      { id: 'race', label: 'Competición', desc: 'Tablas de rendimiento para carreras y remo deportivo.', image: 'https://assets.agrospear.com/site/products/2026/race/race-01.avif', href: '/products/sup-leviathan-wake' },
      { id: 'whitewater', label: 'Aguas Bravas', desc: 'Tablas resistentes diseñadas para rápidos de río y estilo de vida.', image: 'https://assets.agrospear.com/site/products/2026/whitewater/whitewater-01.avif', href: '/products/sup-ocean-pulse' },
      { id: 'yoga', label: 'Yoga', desc: 'Cubiertas amplias diseñadas para yoga y fitness.', image: 'https://assets.agrospear.com/site/products/2026/yoga/yoga-01.avif', href: '/products/sup-flowing-lotus' },
      { id: 'surf', label: 'Surf', desc: 'Tablas ágiles para cazar olas y surfear.', image: 'https://assets.agrospear.com/site/products/2026/surf/surf-01.avif', href: '/products/sup-cheetah-surge' },
      { id: 'fishing', label: 'Pesca', desc: 'Plataformas estables con portacañas y casco utilitario para la pesca.', image: 'https://assets.agrospear.com/site/products/2026/fishing/fishing-01.avif', href: '/products/sup-fishing' },
      { id: 'kids', label: 'SUP Infantil', desc: 'Tablas más pequeñas y ligeras diseñadas para niños.', image: 'https://assets.agrospear.com/site/products/2026/kids-teens/kids-teens-05.avif', href: '/products/sup-mini' },
      { id: 'multi', label: 'Multipersona', desc: 'Tablas de equipo de gran formato para 6–8 remeros.', image: 'https://assets.agrospear.com/site/products/2026/giant/giant-03.avif', href: '/products/sup-giant' },
    ],
  },
}
...
export const cta: Localized<CtaContent> = {
  en: {
    ...
    note: 'Reply within 1 business day · NDA on request before file exchange · info@agrospear.com · +86-13305324192',
  },
  es: {
    ...
    note: 'Respuesta en 1 día laborable · NDA disponible antes del intercambio de archivos · info@agrospear.com · +86-13305324192',
  },
}
...
export const about: Localized<AboutContent> = {
  en: {
    ...
    story: [
      ...
      'So we built Agrospear around them. Tiered minimums from 5–10-unit co-branding runs, complete engineering and design support, and a manufacturing team that treats your first order as seriously as your hundredth. You bring the brand; we run the factory.',
    ],
    values: [
      {
        title: 'Quality First',
    ...
    partnering: {
      ...
      body: [
        'Agrospear works with SUP brands, distributors, resorts, schools and outdoor companies that need a reliable inflatable paddle board factory — from a first trial order to container-scale programs.',
  ...
  es: {
    ...
    story: [
      ...
      'Por eso construimos Agrospear a su alrededor. Pedidos mínimos por tramos desde 5–10 unidades de co-branding, soporte de ingeniería y diseño completo, y un equipo de fabricación que trata tu primer pedido con la misma seriedad que el centésimo. Tú traes la marca; nosotros dirigimos la fábrica.',
    ],
    values: [
      {
    ...
    partnering: {
      ...
      body: [
        'Agrospear trabaja con marcas de SUP, distribuidores, resorts, escuelas y empresas de actividades al aire libre que necesitan una fábrica de tablas hinchables fiable — desde el primer pedido de prueba hasta programas de producción por volumen.',
    ...
    items: [
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/editions/leviathan-whale-edition.avif',
      ...
      },
      {
        ...
        image: 'https://assets.agrospear.com/site/products/2026/editions/medusa-jellyfish-edition.avif',
