...
export const esProduct = {
  ...
  sup: {
    nav: {
      ...
      oemDropdown: {
        ...
        moqLeadTime: 'MOQ y Plazos para SUP Personalizados',
      ...
      productsServicesDropdown: {
        ...
        startProject: 'Inicia Tu Proyecto SUP',
        all: 'Todos los productos',
        customizer: 'Diseña tu SUP',
        manufacturer: 'Fabricación OEM/ODM',
        constructionComparison: 'Comparación de Construcción SUP',
        privateLabel: 'SUP de Marca Propia',
      ...
      proofQualityDropdown: {
        ...
        proofCenter: 'Centro de Evidencia — Datos de Fábrica',
        quality: 'Calidad y ensayos',
        complianceByMarket: 'Cumplimiento SUP por Mercado',
    ...
    footer: {
      ...
      productDevelopment: 'Desarrollo de producto SUP', resortSolutions: 'Soluciones para resorts y clubes',
      faq: 'Preguntas frecuentes',
  ...
  inquiry: {
    ...
    entityMetaTitle: `${SITE_NAME} | Fabricante de SUP hinchables OEM/ODM`,
    entityMetaDescription: `${SITE_NAME}: fabricación de SUP hinchables OEM/ODM con ingeniería, moldes, muestras y producción a gran escala, por ${BRAND_COMPANY_NAME}.`,
    ...
    skillPathsSub: 'Guías y tutoriales paso a paso organizados por nivel de habilidad — desde los conceptos básicos del SUP hasta técnicas avanzadas de rescate.',
