...
export const esUi = {
  ...
  content: {
    ...
    seo: {
      ...
      productsDesc: 'Diez series de SUP probadas, de clásicos polivalentes a ediciones de diseño, como plataformas de fabricación para marcas y resorts.',
      ...
      contactDesc: 'Inicia tu proyecto SUP a medida: fabricamos tablas hinchables bajo tu marca, desde lotes piloto de 20–50 uds. hasta producción a gran escala.',
      aboutTitle: 'Sobre {siteName} | Fabricante de tablas SUP a medida | OEM/ODM',
      aboutDesc: '{siteName} — fabricante OEM/ODM de SUP hinchables a medida: diseño, prototipos, moldes, muestras, QC y exportación desde Qingdao.',
      ...
      faqDesc: 'Preguntas frecuentes sobre la fabricación OEM/ODM de SUP hinchables agrospear — materiales, certificaciones, cantidades mínimas de pedido y logística mayorista.',
