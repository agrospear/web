...
export const FACTS = {
  ...
  materialRollNote: 'A standard production batch yields different quantities depending on formulation concentration, packaging size and regulatory requirements. The 20+ ton MOQ represents the minimum batch per formulation, not a fixed volume.',
  moqDecisionTree: [
  ...
  cncAccuracy: '±0.1% dosing precision',
  rfPower: '2 × 5,000 L reactor lines',
  dropStitchPsi: 'N/A (not applicable to agrochemical formulation)',
  evaHardness: 'N/A (not applicable to agrochemical formulation)',
  pressureTest: 'HPLC purity · GC residue · stability test',
  pressureReject: 'Out-of-spec purity or residue (auto-reject)',
