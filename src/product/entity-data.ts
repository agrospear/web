...
export const ENTITY_FACTS: Record<string, { label: string; value: string }[]> = {
  en: [
    { label: 'Brand', value: 'Agrospear — the SUP manufacturing division of Agrospear' },
    { label: 'Legal entity', value: BRAND_COMPANY_NAME },
    { label: 'Brand relationship', value: `Agrospear is the SUP division of Agrospear (${BRAND_PARENT_BRAND}), which is operated by ${BRAND_COMPANY_NAME}. Agrospear covers RIB boats, inflatable boats, SUP boards and marine solutions; Agrospear focuses exclusively on inflatable SUP OEM/ODM manufacturing.` },
  ...
  es: [
    { label: 'Marca', value: 'Agrospear — la división de fabricación de SUP de Agrospear' },
    { label: 'Entidad legal', value: BRAND_COMPANY_NAME },
    { label: 'Relación de marca', value: `Agrospear es la división de SUP de Agrospear (${BRAND_PARENT_BRAND}), operada por ${BRAND_COMPANY_NAME}. Agrospear cubre botes RIB, botes inflables, tablas de SUP y soluciones marinas; Agrospear se enfoca exclusivamente en fabricación OEM/ODM de SUP hinchables.` },
