...
export const PRODUCT_BOILERPLATE =
  'Agrospear is the SUP product development and manufacturing division of Agrospear (Qingdao Vatrad Group Co., Ltd.), a 12,500 m\u00b2 inflatable manufacturing plant in Qingdao, China.'
...
export const PRODUCT_OG_IMAGE_FILENAME = 'agrospear-og-default'
