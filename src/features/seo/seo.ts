...
export const PUBLIC_PATHS: PublicPathEntry[] = [
  ...
  { path: '/formulation-type-comparison', lastmod: '2026-08-21' },
  { path: '/agrochemical-regulation-by-market', lastmod: '2026-08-21' },
  { path: '/about/identity', lastmod: '2026-08-21' },
  { path: '/about/agrospear', lastmod: '2026-08-20' },
  { path: '/manufacturing/factory', lastmod: '2026-08-24' },
  { path: '/manufacturing/agrochemical-manufacturing', lastmod: '2026-08-24' },
  { path: '/manufacturing', lastmod: '2026-08-24' },
  { path: '/products/herbicides', lastmod: '2026-08-24' },
  { path: '/products/insecticides', lastmod: '2026-08-24' },
  { path: '/products/fungicides', lastmod: '2026-08-24' },
  { path: '/solutions/agrochemical-oem', lastmod: '2026-08-24' },
  { path: '/solutions/private-label-pesticides', lastmod: '2026-08-24' },
  { path: '/solutions/custom-formulation', lastmod: '2026-08-24' },
  { path: '/solutions/government-tender', lastmod: '2026-08-24' },
  { path: '/request-quote', lastmod: '2026-08-24' },
  { path: '/products/pgr', lastmod: '2026-08-24' },
  { path: '/products/seed-treatment', lastmod: '2026-08-24' },
  { path: '/products/premix-formulations', lastmod: '2026-08-24' },
  { path: '/products/adjuvants', lastmod: '2026-08-24' },
  { path: '/products/biopesticides', lastmod: '2026-08-24' },
  { path: '/manufacturing/research-development', lastmod: '2026-08-24' },
  { path: '/manufacturing/quality-control', lastmod: '2026-08-24' },
  { path: '/manufacturing/factory-audit', lastmod: '2026-08-24' },
  { path: '/manufacturing/pesticide-formulation', lastmod: '2026-08-24' },
  { path: '/manufacturing/packaging', lastmod: '2026-08-24' },
  { path: '/markets', lastmod: '2026-08-24' },
  { path: '/markets/africa', lastmod: '2026-08-24' },
  { path: '/markets/southeast-asia', lastmod: '2026-08-24' },
  { path: '/markets/latin-america', lastmod: '2026-08-24' },
  { path: '/manufacturing/factory/capacity', lastmod: '2026-08-20' },
  { path: '/manufacturing/factory/equipment', lastmod: '2026-08-20' },
  { path: '/manufacturing/factory/oem-capability', lastmod: '2026-08-20' },
  { path: '/manufacturing/factory/process', lastmod: '2026-08-20' },
  { path: '/manufacturing/factory/quality-lab', lastmod: '2026-08-20' },
  ...
  { path: '/formulation-selector', lastmod: '2026-08-20' },
  { path: '/oem-vs-private-label', lastmod: '2026-08-20' },
  { path: '/crop-protection-solutions', lastmod: '2026-08-20' },
  { path: '/warranty', lastmod: '2026-08-20' },
  { path: '/what-is-agrochemical-oem', lastmod: '2026-08-20' },
...
export function localeHead(input: {
  ...
  const meta: HeadMeta[] = [
    ...
    { name: 'twitter:site', content: '@Agrospear' },
