...
const SERVICE_SCHEMA_PAGES: Record<string, { serviceType: string; description: string }> = {
  '/oem-manufacturing': { serviceType: 'OEM Manufacturing', description: 'Full OEM manufacturing for agrochemical formulations — buyer-owned specifications, custom formulation development, and production under your brand.' },
  ...
  '/factory/oem-capability': { serviceType: 'Factory OEM Capability', description: 'Factory OEM capabilities: production lines, formulation reactors, quality gates, and capacity for custom agrochemical manufacturing.' },
  '/oem-moq-guide': { serviceType: 'OEM MOQ Guide', description: 'Minimum order quantities for OEM manufacturing: per-formulation thresholds, pilot batch options, and raw-material considerations.' },
  ...
  '/agrochemical-oem-moq-lead-time': { serviceType: 'Agrochemical OEM MOQ & Lead Time', description: 'Agrochemical-specific OEM minimum order quantities and lead times — per-formulation MOQ, registration timelines, and sample turnaround.' },
  ...
  '/formulation-type-comparison': { serviceType: 'Formulation Type Comparison', description: 'Technical comparison of SC, EC, WP, WDG, SL, ME, CS and FS formulation types — stability, efficacy, handling and use-case guidance.' },
  '/agrochemical-regulation-by-market': { serviceType: 'Agrochemical Regulation by Market', description: 'Market-by-market registration and compliance guide: ICAMA, FAO/WHO, ISO 9001, BSCI, REACH requirements for agrochemical products.' },
  '/factory-audit-checklist': { serviceType: 'Factory Audit Checklist', description: 'Eight-area factory audit checklist for agrochemical buyers: quality system, capacity, traceability, specification testing, formulation controls, social compliance, documentation, and post-delivery support.' },
  ...
  '/oem-paddle': { serviceType: 'OEM Application Equipment', description: 'OEM application equipment manufacturing: sprayers, dosing systems and accessories for crop protection product lines.' },
