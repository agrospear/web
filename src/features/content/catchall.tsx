...
const SERVICE_SCHEMA_PAGES: Record<string, { serviceType: string; description: string }> = {
  ...
  '/manufacturing/factory/oem-capability': { serviceType: 'Factory OEM Capability', description: 'Factory OEM capabilities: production lines, formulation reactors, quality gates, and capacity for custom agrochemical manufacturing.' },
