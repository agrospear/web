...
export function llmsAgrospearFull(): string {
  const DEEP_PAGES = new Set([
    ...
    '/manufacturing/factory/quality-inspection',
    '/manufacturing/factory/quality-change-control',
    '/manufacturing/factory/non-conforming-control',
    '/manufacturing/quality-control',
    '/manufacturing/research-development',
    '/manufacturing/research-development/formulation-engineering',
    '/manufacturing/research-development/formulation-pilot-plant',
    '/manufacturing/research-development/prototype-workshop',
    '/manufacturing/research-development/formulation-lab',
    '/manufacturing/research-development/quality-inspection-lab',
    '/manufacturing/research-development/formulation-equipment',
    '/solutions/agrochemical-oem',
    '/products/adjuvants',
    ...
    '/solutions/distributor-partners',
    '/solutions/distributors',
    '/oem/agrochemical-oem-west-asia',
    '/oem/agrochemical-oem-central-asia',
    '/research/formulation-technology',
    '/research/adjuvant-types',
    '/research/icama-registration',
    '/research/formulation-stability',
