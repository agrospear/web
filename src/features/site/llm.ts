...
export function llmsAgrospearFull(): string {
  const DEEP_PAGES = new Set([
    ...
    '/partners', '/news', '/technology', '/formulation-selector',
    '/biopesticide', '/oem-vs-private-label', '/crop-protection-solutions',
    '/warranty', '/what-is-agrochemical-oem',
    '/solutions/co-branding', '/solutions/distributor-partners', '/solutions/distributors',
    '/randdcenter', '/randdcenter/formulation-engineering', '/randdcenter/formulation-pilot-plant',
    '/randdcenter/prototype-workshop', '/randdcenter/formulation-lab',
    '/randdcenter/quality-inspection-lab', '/randdcenter/formulation-equipment',
