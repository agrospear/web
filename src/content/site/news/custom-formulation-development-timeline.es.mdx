...
excerpt: 'Un calendario realista para el desarrollo de formulaciones agroquímicas a medida: 7–15 días para la primera muestra de laboratorio, 25–35 días de producción tras el PO, más ensayos de estabilidad y envío.'
...
metadata:
  ...
  description: 'Cuánto tarda realmente el desarrollo de una formulación agroquímica a medida: muestras de laboratorio en 7–15 días, producción en 25–35 días, estabilidad acelerada en 2–4 semanas y flete marítimo — con los equilibrios de plazo que importan.'
---

### La respuesta directa

Para una formulación agroquímica a medida, desde las especificaciones aprobadas hasta las muestras en mano: **7–15 días para la primera muestra de laboratorio** y luego **25–35 días de producción** tras el PO y el depósito para tiradas OEM estándar. Si además necesitas I+D de formulación nueva (combinación de i.a. novedosa o sistema de coadyuvantes no estándar, no una plataforma existente), añade **2–4 semanas de cribado de I+D** al inicio. Los ensayos de estabilidad acelerada añaden **2–4 semanas** para la generación de datos. El flete marítimo añade unas 4–6 semanas a la mayoría de los destinos. Realista de principio a fin: **unos 2–3 meses desde la aprobación de la especificación hasta el contenedor completo**, y **3–4 meses si el proyecto requiere I+D a medida y datos completos de estabilidad**.
