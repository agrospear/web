...
Nuestro equivalente público: el [QIP del proyecto](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_SUP_OEM_QIP.pdf) y el [paquete de documentación de calidad](https://assets.agrospear.com/site/downloads/Qingdao_Vatrad_Group_SUP_Quality_Documentation_Pack.pdf) — descárgalos y verás la estructura exacta con la que se controla cada pedido.
...
Ver la estructura real en los [informes de prueba IQC](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_IQC_TEST_REPORTS.pdf).
...
Nuestras tablas se prueban a presión al 100% por cámara, y los [informes de prueba de estanqueidad](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_AIRTIGHTNESS_TEST_REPORTS.pdf) muestran la estructura de registro detrás de esa afirmación.
...
Evidencia pública: [informes de prueba FQC](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_FQC_TEST_REPORTS.pdf) y [informes de prueba PSI](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_PSI_TEST_REPORTS.pdf).
...
Nuestro [expediente de trazabilidad y control de NCR](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_BATCH_TRACEABILITY_AND_NCR_CONTROL_DOSSIER.pdf) y la [SOP de control de producto no conforme](https://assets.agrospear.com/site/downloads/non-conforming-product-control-sop-iso-8-7.pdf) documentan este bucle, incluido el desecho solo después de un certificado de destrucción firmado.
...
Nosotros practicamos esta prueba en nuestra propia planta: los registros de lote enlazan tabla, materiales, revisiones de documentos, inspectores y estado de liberación de principio a fin — ver la estructura en el [expediente de trazabilidad de lotes](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_BATCH_TRACEABILITY_AND_NCR_CONTROL_DOSSIER.pdf). Lo que se muestra públicamente está anonimizado; los expedientes completos del proyecto, certificados de calibración, NCR, CAPA y archivos de formación se comparten bajo auditoría o NDA, donde se protege la confidencialidad comercial.
