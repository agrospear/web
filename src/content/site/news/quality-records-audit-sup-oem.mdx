...
Our equivalent on the public side: the [project QIP](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_SUP_OEM_QIP.pdf) and the [quality documentation pack](https://assets.agrospear.com/site/downloads/Qingdao_Vatrad_Group_SUP_Quality_Documentation_Pack.pdf) — download them and you see the exact structure every order is controlled against.
...
See the real structure in the [IQC test reports](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_IQC_TEST_REPORTS.pdf).
...
Our boards are 100% pressure-tested per chamber, and the [air-tightness test reports](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_AIRTIGHTNESS_TEST_REPORTS.pdf) show the record structure behind that claim.
...
Public evidence: [FQC test reports](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_FQC_TEST_REPORTS.pdf) and [PSI test reports](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_PSI_TEST_REPORTS.pdf).
...
Our [traceability and NCR control dossier](https://assets.agrospear.com/site/downloads/QINGDAO_VATRAD_GROUP_BATCH_TRACEABILITY_AND_NCR_CONTROL_DOSSIER.pdf) and the [non-conforming product control SOP](https://assets.agrospear.com/site/downloads/non-conforming-product-control-sop-iso-8-7.pdf) document this loop, including scrap only after a signed destruction certificate.
