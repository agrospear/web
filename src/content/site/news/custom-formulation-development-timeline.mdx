...
excerpt: 'A realistic timeline for custom agrochemical formulation development: 7–15 days for the first lab sample, 25–35 days for production after PO, plus stability testing and shipping.'
...
### Phase 2: Lab Sample Production (7–15 days)

For formulation customizations on an existing platform (standard a.i. in a proven SC, EC or WP base), the first lab sample ships in 7–15 days after specification approval. For a novel formulation requiring new R&D screening, the 2–4 week screening phase comes first — candidate formulations are prepared, tested for content, suspension rate and pH, and the most promising is selected for the full sample.
